...
- **2026-05-02 18:25**: push to github
- **2026-05-02 18:25**: Run actions/deploy-pages@v4
Fetching artifact metadata for "github-pages" in this workflow run
Found 1 artifact(s)
Creating Pages deployment with payload:
{
    "artifact_id": 6762130118,
    "pages_build_version": "f747b0e8b87ab2dcdf8daeab7be20792d06c4362",
    "oidc_token": "***"
}
...
Error: Error: Failed to create deployment (status: 404) with build version f747b0e8b87ab2dcdf8daeab7be20792d06c4362. Request ID 9008:12DD2:60779A:18B00ED:69F5C30A Ensure GitHub Pages has been enabled: https://github.com/tank3a/portfolio-app-v2/settings/pages
- **2026-05-02 18:37**: 메인 페이지에 아무것도 안뜨는게 무슨일이지?
- **2026-05-02 18:38**: 파일을 로드한 이후로 흰화면에 도움말 아이콘만 보인다. 원래는 메인페이지가 보여야한다
No routes matched location "/portfolio-app-v2/" 
warning @ react-router-dom.js?v=fc5236fb:212
useRoutesImpl @ react-router-dom.js?v=fc5236fb:4024
useRoutes @ react-router-dom.js?v=fc5236fb:3977
Routes @ react-router-dom.js?v=fc5236fb:4602
renderWithHooks @ chunk-SVG7M4VJ.js?v=fc5236fb:11594
mountIndeterminateComponent @ chunk-SVG7M4VJ.js?v=fc5236fb:14972
beginWork @ chunk-SVG7M4VJ.js?v=fc5236fb:15960
beginWork$1 @ chunk-SVG7M4VJ.js?v=fc5236fb:19804
performUnitOfWork @ chunk-SVG7M4VJ.js?v=fc5236fb:19249
workLoopSync @ chunk-SVG7M4VJ.js?v=fc5236fb:19188
renderRootSync @ chunk-SVG7M4VJ.js?v=fc5236fb:19167
performConcurrentWorkOnRoot @ chunk-SVG7M4VJ.js?v=fc5236fb:18726
workLoop @ chunk-SVG7M4VJ.js?v=fc5236fb:195
flushWork @ chunk-SVG7M4VJ.js?v=fc5236fb:174
performWorkUntilDeadline @ chunk-SVG7M4VJ.js?v=fc5236fb:382
postMessage
schedulePerformWorkUntilDeadline @ chunk-SVG7M4VJ.js?v=fc5236fb:405
requestHostCallback @ chunk-SVG7M4VJ.js?v=fc5236fb:416
unstable_scheduleCallback @ chunk-SVG7M4VJ.js?v=fc5236fb:328
scheduleCallback$1 @ chunk-SVG7M4VJ.js?v=fc5236fb:19877
ensureRootIsScheduled @ chunk-SVG7M4VJ.js?v=fc5236fb:18700
scheduleUpdateOnFiber @ chunk-SVG7M4VJ.js?v=fc5236fb:18610
dispatchSetState @ chunk-SVG7M4VJ.js?v=fc5236fb:12449
(anonymous) @ useFileData.js:86
await in (anonymous)
(anonymous) @ useFileData.js:94
commitHookEffectListMount @ chunk-SVG7M4VJ.js?v=fc5236fb:16961
commitPassiveMountOnFiber @ chunk-SVG7M4VJ.js?v=fc5236fb:18204
commitPassiveMountEffects_complete @ chunk-SVG7M4VJ.js?v=fc5236fb:18177
commitPassiveMountEffects_begin @ chunk-SVG7M4VJ.js?v=fc5236fb:18167
commitPassiveMountEffects @ chunk-SVG7M4VJ.js?v=fc5236fb:18157
flushPassiveEffectsImpl @ chunk-SVG7M4VJ.js?v=fc5236fb:19541
flushPassiveEffects @ chunk-SVG7M4VJ.js?v=fc5236fb:19498
(anonymous) @ chunk-SVG7M4VJ.js?v=fc5236fb:19379
workLoop @ chunk-SVG7M4VJ.js?v=fc5236fb:195
flushWork @ chunk-SVG7M4VJ.js?v=fc5236fb:174
performWorkUntilDeadline @ chunk-SVG7M4VJ.js?v=fc5236fb:382
postMessage
...
ensureRootIsScheduled @ chunk-SVG7M4VJ.js?v=fc5236fb:18700
scheduleUpdateOnFiber @ chunk-SVG7M4VJ.js?v=fc5236fb:18610
updateContainer @ chunk-SVG7M4VJ.js?v=fc5236fb:20832
ReactDOMHydrationRoot.render.ReactDOMRoot.render @ chunk-SVG7M4VJ.js?v=fc5236fb:21172
(anonymous) @ main.jsx:6
- **2026-05-02 19:01**: 투자 메인페이지에서 카테고리 추가 시, 투자 상세페이지에 반영이 되지만, 투자 상세페이지에서 생긴 카테고리에 항목 추가 시 추가가 되지 않는다. 버그 수정
- **2026-05-02 19:55**: 카테고리 제거 시 현재 월부터 이후 월들에만 지워저야 하는데, 이전 월도 같이 지워지는 것 같다. 버그 수정
- **2026-05-02 20:00**: # Update Config Skill
...
```
- **2026-05-02 20:06**: 각 탭에서 카테고리나 항목을 추가할 때 중복 이름이 존재한다면 key 중복으로 인해 오류가 발생하는데, 입력자체는 가능하게 된다. 하지만 처리 시 이전에 입력된 내용이 지워지는 것 같은데, 입력된 key값이 이미 존재한다면 입력 저장이 불가능하도록 막아
- **2026-05-02 20:09**: 도움말에서 history내용을 기반으로  변경된 내용들 중 사용자에게 알려줄만한 추가내용이 있다면 알려줘
- **2026-05-02 20:33**: 정기수입의 항목은 모든 월에 반영이 되어야하는데 반영이 안되는것으로 보인다. 추가해라
- **2026-05-02 21:18**: github push 진행해
- **2026-05-03 01:11**: 주식 카테고리에서 항목 추가시 추가금을 입력하는게 아니라, 다른 카테고리(예금, 채권, 연금)에서도 항목 추가시 추가금을 넣을 수 있도록 해라
